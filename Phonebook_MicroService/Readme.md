...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Phonebook_MicroService*):

Restore dependencies
```
    cd "Phonebook_MicroService"
    dotnet restore
```

Execute unit tests
```
    cd "Phonebook_MicroService/test/Phonebook_MicroService.Tests"
    dotnet test
```

Deploy application
```
    cd "Phonebook_MicroService/src/Phonebook_MicroService"
